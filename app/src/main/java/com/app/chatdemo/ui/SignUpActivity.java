...
import com.app.chatdemo.model.Country;
...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void init(){
        ...
        txt_otp=findViewById(R.id.opt_text);
    ...
    public void getcountry(){
        ...
        try {
            ...
            for (int i = 0; i < countrArray.length(); i++) {
                ...
                toReturn.add(jsonObject.getString("name")+" ("+jsonObject.getString("dial_code")+")");
            }
            ...
            ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(this, R.layout.item_country_spinner, toReturn);
            et_country.setAdapter(myAdapter);
